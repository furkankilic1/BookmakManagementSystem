    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card horizontal">
                <div class="card-image hide-on-small-only pht">
                    <img class="pht" src="img/register.jpg">
                </div>
                        ...
                        <form action="?page=register" method="post">
                            <div class="row">
                                ...
                                <div class="input-field col s11 offset-s1 center">
                                    <button type="submit" style="background: #142850;" class="submit-btn waves-effect waves-light btn-large colorBtn">Register</button>
                                </div>
                            </div>
                        </form> 
                    </div>
